      ...
      <div className="box">
        <div className="description-container" role="main">
            ...
            <HistoryItem>
                ...
                {' '}
                <a href="http://www.apple.com/" target="_blank" rel="noopener">Apple</a>
.
                            </HistoryItem>
            <HistoryItem>
                    I was previously a creative technologist at
                {' '}
                <a href="http://www.akqa.com/" target="_blank" rel="noopener">AKQA</a>
, a data journalist at
                {' '}
                <a href="http://www.h2o.ai/" target="_blank" rel="noopener">H2O.ai</a>
, and an intern at the
                {' '}
                <a href="http://youarehere.cc/" target="_blank" rel="noopener">MIT Media Lab</a>
.
                            </HistoryItem>
            <HistoryItem>
                    I graduated from
                {' '}
                <a href="http://www.berkeley.edu/" target="_blank" rel="noopener">UC Berkeley</a>
                {' '}
with a Bachelor of Arts in
                {' '}
                <a href="https://math.berkeley.edu/" target="_blank" rel="noopener">Mathematics</a>
, a minor in
                {' '}
                <a href="https://nature.berkeley.edu/advising/minors/gist" target="_blank" rel="noopener">GIST</a>
, a certificate in
                {' '}
                <a href="http://bcnm.berkeley.edu/" target="_blank" rel="noopener">New Media</a>
, and a desire to create great data visualization.
                            </HistoryItem>
            <HistoryItem>
                    I love to read books, play board games (current favorites are
                {' '}
                <a href="https://boardgamegeek.com/boardgame/2651/power-grid" target="_blank" rel="noopener">Power Grid</a>
                {' '}
&
                {' '}
